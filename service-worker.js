...
const CACHE_NAME = 'rishiri-kelp-v2-6-30';
const STATIC_CACHE_NAME = 'rishiri-kelp-static-v2-6-30';
const WEATHER_CACHE_NAME = 'rishiri-kelp-weather-v2-6-30';
...
async function handleStaticRequest(request) {
    if (request.destination === 'document') {
        try {
            ...
            console.log('Service Worker: Failed to fetch document, trying cache', request.url);
